...
function app(options) {
  ...
  if (options.transpiler === 'ts') {
    ...
    files = files.concat(['client/.jshintrc']);
  }
  ...
  if (options.oauth && options.oauth.length) {
    ...
    files = files.concat(['client/components/oauth-buttons/oauth-buttons.' + stylesheet, 'client/components/oauth-buttons/oauth-buttons.' + markup, 'client/components/oauth-buttons/oauth-buttons.controller.' + script, 'client/components/oauth-buttons/oauth-buttons.controller.spec.' + script, 'client/components/oauth-buttons/oauth-buttons.directive.' + script, 'client/components/oauth-buttons/oauth-buttons.directive.spec.' + script, 'e2e/components/oauth-buttons/oauth-buttons.po.js']);
  }
